...
def main():
    ...
    build_randn_projection_vectors(dirnames_no_alg_ind, dest_path_matrices_no_na_proj)
    build_randn_projection_vectors(path_all_data_eigen_no_alg_ind, dest_path_all_data_proj)
    build_randn_projection_vectors(dirnames_w_alg_ind, dest_path_matrices_no_na_proj)
    build_randn_projection_vectors(path_all_data_eigen_w_alg_ind, dest_path_all_data_proj)
